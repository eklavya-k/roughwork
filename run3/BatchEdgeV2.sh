...
edgeConfig=$(curl https://flux.internal.reports.mn/GetEdgeConfigs\?id="$2")
...
HADOOP_USER_NAME=hdfs spark-submit \
    ...
    --conf spark.driver.extraClassPath=snakeyaml-1.10.jar:$DATA_DRIVER_CLASSPATH:gcs-connector-hadoop2-2.1.3-shaded.jar \
    --conf spark.executor.extraClassPath=snakeyaml-1.10.jar:$DATA_EXECUTOR_CLASSPATH:gcs-connector-hadoop2-2.1.3-shaded.jar \
